...
const FeaturedProperties = () => {
  return <div className="container mx-auto border-b py-6 pb-10">
    ...
    <div className="flex flex-wrap">
        {FEATURED_PROPERTIES.map((property, index) => (
            <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4"> 
                ...
                <div className="p-8">
                    <Image className="mb-8 rounded-md object-cover" src={property.image} width={300} height={300} alt={property.name} />
                    <div className="text-center">
                        <h6 className="mb-5 mt-2 font-medium">{property.name}</h6>
                        <span className="mb-5 mt-2">${property.price}</span>
                        <div className="mt-2 flex intems-center justify-center">
